...
(function () {
  ...
  VM.pages.contact = function () {
    ...
    form.addEventListener('submit', function (e) {
      ...
      VM.toast('Message sent \u{1F3B5}', 'Thanks ' + name + ' \u2014 we\u2019ll reply within 24 hours.', 'ok');
  ...
  var POLICIES = {
    privacy: {
      ...
      body: [
        ['What we collect', 'When you shop or contact Victor\u2019s Music we may collect your name, email address, phone number, delivery address and order history. This is a demo storefront \u2014 data entered is stored only in your own browser (localStorage) and never transmitted to any server.'],
        ...
        ['Your rights', 'You may request a copy or deletion of the information you have shared with us at any time by contacting hello@victorsmusic.ng.']
      ]
    },
    terms: {
      ...
      updated: 'September 2026',
      body: [
        ['General', 'These terms govern your use of the Victor\u2019s Music website and the demo ordering flow. By browsing or ordering you agree to them. This project is an academic/demo build; product listings are illustrative sample data.'],
        ...
        ['Liability', 'Victor\u2019s Music is not liable for indirect losses arising from use of the site, and is not responsible for any third-party content linked from it.']
      ]
    },
    returns: {
      ...
      body: [
        ...
        ['Damaged or faulty items', 'If your order arrives damaged or develops a fault within 30 days, we will repair or replace it free of charge \u2014 just send photos and your order number to returns@victorsmusic.ng.'],
        ...
        ['How to return', 'Contact our support team or visit any Victor\u2019s Music store with your proof of purchase. Refunds are processed within 5\u20137 business days after we receive the returned item.'],
  ...
  VM.pages.policy = function () {
    ...
    if (emEl) emEl.textContent = pol.emoji;
